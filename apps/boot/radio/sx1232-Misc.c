...
{
    SX1232Read( REG_PAYLOADLENGTH, &SX1232->RegPayloadLength );
...
{
    SX1232Read( REG_IRQFLAGS1, &SX1232->RegIrqFlags1 );

    return SX1232->RegIrqFlags1;
}

uint8_t SX1232GetFlags2( void )
{
    SX1232Read( REG_IRQFLAGS2, &SX1232->RegIrqFlags2 );

    return SX1232->RegIrqFlags2;
}
