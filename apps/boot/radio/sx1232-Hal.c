...
void SX1232InitIo( void )
{
    ...
    {
        EGL_LOG_ERROR("Fail to init rfm reset pin. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
    ...
    if(result != EGL_SUCCESS)
    {
        EGL_LOG_ERROR("Fail to set rfm nss pin. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
    ...
    if(result != EGL_SUCCESS)
    {
        EGL_LOG_ERROR("Fail to init rfm dio0 pin. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
    ...
    if(result != EGL_SUCCESS)
    {
        EGL_LOG_ERROR("Fail to init rfm dio2 pin. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
    ...
    if(result != EGL_SUCCESS)
    {
        EGL_LOG_ERROR("Fail to init rfm dio4 pin. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
    ...
    if(result != EGL_SUCCESS)
    {
        EGL_LOG_ERROR("Fail to init rfm dio5 pin. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
    ...
    if(result != EGL_SUCCESS)
    {
        EGL_LOG_ERROR("Fail to init rfm interface. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
}
...
void SX1232SetReset( uint8_t state )
{
    ...
    if(result != EGL_SUCCESS)
    {
        EGL_LOG_ERROR("Fail to set rfm reset pin. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
}
...
void SX1232WriteBuffer( uint8_t addr, uint8_t *buffer, uint8_t size )
{
    ...
    if(result != EGL_SUCCESS)
    {
        EGL_LOG_ERROR("Fail to write address. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
    ...
    if(result != EGL_SUCCESS)
    {
        EGL_LOG_ERROR("Fail to write data. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
...
void SX1232ReadBuffer( uint8_t addr, uint8_t *buffer, uint8_t size )
{
    ...
    if(result != EGL_SUCCESS)
    {
        EGL_LOG_ERROR("Fail to read data. Result %s", EGL_RESULT(result));
        EGL_RESULT_FATAL();
    }
...
uint8_t SX1232ReadDio0( void )
{
    ...
    {
        EGL_LOG_ERROR("Fail to Get DIO0 pin. Result: %s", EGL_RESULT(result));
    }
