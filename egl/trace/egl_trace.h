...
egl_result_t egl_trace(egl_trace_level_t lvl, char* module, char* format, ...);
...
egl_trace_t *egl_trace_default_get(egl_trace_t *trace) { return EGL_SUCCESS; }
#endif
