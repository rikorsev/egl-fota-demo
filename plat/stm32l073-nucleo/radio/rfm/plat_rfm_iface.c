...
static egl_result_t write_addr(uint32_t addr, void *data, size_t *len)
{
    /* Set NSS */
...
static egl_result_t read_addr(uint32_t addr, void *data, size_t *len)
{
...
const egl_iface_t plat_rfm_iface_inst =
{
    .init = init,
