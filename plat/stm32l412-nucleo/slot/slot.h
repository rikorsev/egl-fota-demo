...
#define CONFIG_SLOT_INFO_VERSION_SUFIX_BUFF_SIZE     (8U)
#define CONFIG_SLOT_INFO_GIT_BRANCH_SUFIX_BUFF_SIZE  (32U)
#define CONFIG_SLOT_INFO_GIT_HASH_SUFIX_BUFF_SIZE    (41U)
...
typedef struct
{
    char branch[CONFIG_SLOT_INFO_GIT_BRANCH_SUFIX_BUFF_SIZE];
    char commit[CONFIG_SLOT_INFO_GIT_HASH_SUFIX_BUFF_SIZE];
}slot_git_t;
