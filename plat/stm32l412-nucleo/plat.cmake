...
set(CONFIG_PLAT_INFO_SECTION_SIZE 256)
add_definitions(-DCONFIG_PLAT_INFO_SECTION_SIZE=${CONFIG_PLAT_INFO_SECTION_SIZE})
set(CONFIG_PLAT_INFO_MAGIC_VALUE 0xAA55AA55)
add_definitions(-DCONFIG_PLAT_INFO_MAGIC_VALUE=${CONFIG_PLAT_INFO_MAGIC_VALUE})
...
if(${PROJECT_NAME} STREQUAL "afd_main")
    # Fullfill the binary with meta
    add_custom_target(${PROJECT_NAME}.${TARGET_SLOT}.bin.meta ALL DEPENDS ${PROJECT_NAME}
        COMMAND python3 ${CMAKE_CURRENT_LIST_DIR}/meta.py ${CMAKE_BINARY_DIR}/${PROJECT_NAME}.${TARGET_SLOT}.bin ${CONFIG_PLAT_INFO_SECTION_SIZE})
endif()